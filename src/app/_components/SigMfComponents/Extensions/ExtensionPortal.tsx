...
function ModalContent({ onClose, extensions, moveData }: { onClose: Function, extensions: Array<string>, moveData: Function }) {
    ...
    return (
        <div className="grid grid-cols-1 place-items-center justify-evenly items-center shadow-zinc-600 dark:bg-zinc-950 border-2 bg-slate-300 absolute w-full h-full bottom-16 top-16">
