...
export default function SigMfCapture({ isHidden }: { isHidden: boolean }) {
    ...
    return (
        <div>
            ...
            <button id="add-cap-button" className={`rounded p-1 mx-auto flex dark:hover:text-slate-200 dark:bg-slate-300 dark:text-indigo-400 dark:hover:bg-slate-500 ${isHidden ? "hidden" : ""}`}>Add Capture</button>
        </div>
    );
}